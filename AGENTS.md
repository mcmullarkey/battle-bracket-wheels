...
- **Evidence to produce:**
  ...
  - Browser probe results (rodney assert) for client-side JS state at `docs/evidence/<issue-number>/rodney.log` — produced by builder-vision-probe, NOT the builder. The builder produces Go test evidence + curl logs only.
